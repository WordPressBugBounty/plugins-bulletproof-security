...
<?php
   ...
   echo sprintf( __( '<a href="%2$s" target="_blank" title="Link Opens in New Browser Window">Whats New in BPS Pro %1$s</a>' ), '17.1', 'https://www.ait-pro.com/aitpro-blog/5789/bulletproof-security-pro/whats-new-in-bulletproof-security-pro-17/' ).'<br>';
   echo sprintf( __( '<a href="%2$s" target="_blank" title="Link Opens in New Browser Window">Whats New in BPS Pro %1$s</a>' ), '17', 'https://www.ait-pro.com/aitpro-blog/5789/bulletproof-security-pro/whats-new-in-bulletproof-security-pro-17/' ).'<br>';
